...
dataString = dataString + String(T6_Rsist_25);  //this only gives you two decimal places
dataString = dataString + ", "; 
dataString = dataString + String(T6_Temp_25);
dataString = dataString + ", ";
dataString = dataString + String(T7_Rsist_25);
dataString = dataString + ", ";
dataString = dataString + String(T7_Temp_25);
dataString = dataString + ", ";
dataString = dataString + String(T8_Rsist_25);
dataString = dataString + ", ";
dataString = dataString + String(T8_Temp_25);
dataString = dataString + ", ";
dataString = dataString + String(T9_Rsist_25);
dataString = dataString + ", ";
dataString = dataString + String(T9_Temp_25);
dataString = dataString + ", ";
dataString = dataString + String(T10_Rsist_25);
dataString = dataString + ", ";
dataString = dataString + String(T10_Temp_25);
dataString = dataString + ", ";
