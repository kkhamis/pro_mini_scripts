...
# lines(Tmistor01$d,Tmistor01$Thermistor,col='blue')
legend('topright',c('Digital Thermometer','Thermistor'), col=c('orange','blue'),pch=1)
text(y=15.2,x=as.POSIXlt('2021-01-27 23:30:00 GMT'),paste('Step change thermistor',round(min(Tmistor1415$diff),3),'-',round(max(Tmistor1415$diff),3)))
text(y=15.4,x=as.POSIXlt('2021-01-27 23:30:00 GMT'),paste('Step change d.thermometer',round(min(Tdigital1415$diff),3),'-',round(max(Tdigital1415$diff),3)))
